...
// Thin Prisma wrapper - keeps DoctorsService free of query-building details and
// gives the mapping layer in doctors.service.ts a single, mockable seam for tests.
@Injectable()
export class DoctorsRepository {
  constructor(private readonly prisma: PrismaService) {}

  findAll(): Promise<Doctor[]> {
    return this.prisma.doctor.findMany({ orderBy: { lastName: 'asc' } });
  }
